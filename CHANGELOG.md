...
- poetry update dependencies, reported by dependabot
...
- open tracking links in new tab

## [0.6.0] - 2026-03-04

### Changed

- migrated Makefile to justfile
- poetry update dependencies
- ci with gitea act_runner

## [0.5.0] - 2025-11-26

### Changed

- use image python:3.12

### Changed

- poetry update
- management of test.db
...
- run via docker as opposed to dokku
